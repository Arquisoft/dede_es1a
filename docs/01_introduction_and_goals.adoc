...
The application will store the information about the users and the products in a database MogoDB. Personal information of the users will be protected with SOLID using pods.
